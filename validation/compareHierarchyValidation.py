...
def processArgs(parser):
    ...
    parser.add_argument('--hFileName', default='numu_all/MCHierarchy_Histos.root', metavar='fileName',
                        help='MC hierarchy histogram ROOT file [default "numu_all/MCHierarchy_Histos.root"]')

    parser.add_argument('--vFileName', default='numu_all/Validation_Histos.root', metavar='fileName',
                        help='Validation histogram ROOT file [default "numu_all/Validation_Histos.root"]')
